...
function preload(){
  ...
  trex_running = loadAnimation("assets/images/trex_2.png","assets/images/trex_1.png","assets/images/trex_3.png");
  trex_collided = loadAnimation("assets/images/trex_collided.png");
  
  groundImage = loadImage("assets/images/ground.png");
  
  cloudImage = loadImage("assets/images/cloud.png");
  
  obstacle1 = loadImage("assets/images/obstacle1.png");
  obstacle2 = loadImage("assets/images/obstacle2.png");
  obstacle3 = loadImage("assets/images/obstacle3.png");
  obstacle4 = loadImage("assets/images/obstacle4.png");
